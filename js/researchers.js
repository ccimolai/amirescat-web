...
const RESEARCHERS = [
  {
    ...
    tagKey: "ch1.tag",
    people: [
      { name: "Fernando Zamora Marín", lider: true, bio: {
  ...
  },
  {
    ...
    tagKey: "ch2.tag",
    people: [
      { name: "Josepa Gené Díaz", lider: true, bio: {
      ...
      { name: "Sandra Contreras", lider: true, bio: {
      ...
      { name: "Dània Garcia", lider: false, bio: {
  ...
  },
  {
    ...
    tagKey: "ch3.tag",
    people: [
      { name: "Fèlix Llovell", lider: true, bio: {
      ...
      { name: "Montserrat Diéguez Fernández", lider: true, bio: {
      ...
      { name: "Bahareh Khezri", lider: false, bio: {
      ...
      { name: "Joan Carles Bruno Argilaguet", lider: false, bio: {
      ...
      { name: "Gerard Lligadas", lider: false, bio: {
      ...
      { name: "Jorge J. Carbó", lider: false, bio: {
      ...
      { name: "Francesc Medina Cabello", lider: false, bio: {
      ...
      { name: "Óscar Pàmies", lider: false, bio: {
  ...
  },
  {
    ...
    tagKey: "ch4.tag",
    people: [
      { name: "Salvador Anton Clavé", lider: false, bio: {
      ...
      { name: "Òscar Saladié", lider: false, bio: {
  ...
  },
  {
    ...
    tagKey: "ch5.tag",
    people: [
      { name: "Alexandre Fabregat Tomàs", lider: true, bio: {
      ...
      { name: "Albert Samper Sosa", lider: false, bio: {
      ...
      { name: "Francesc Borrull Ballarín", lider: false, bio: {
  ...
  },
  {
    ...
    tagKey: null,
    people: [
      { name: "Susana Borràs", lider: true, bio: {
      ...
      { name: "Endrius Cocciolo", lider: true, bio: {
  ...
  },
  {
    ...
    tagKey: null,
    people: [
      { name: "Enric Aguilar", lider: true, bio: {
  ...
  },
  {
    ...
    tagKey: null,
    people: [
      { name: "Gisela Cebrián", lider: true, bio: {
      ...
      { name: "Assumpció Huertas Roig", lider: true, bio: {
  ...
  },
  {
    ...
    tagKey: null,
    people: [
      { name: "Josep-Maria Arauzo-Carod", lider: true, bio: {
      ...
      { name: "Juan Antonio Duro", lider: false, bio: {
